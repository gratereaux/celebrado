...
@section('subtitle', 'Bienvenido ' . Auth::user()->name)
...
<div class="content bg-white border-b">
    <div class="row items-push text-uppercase">
        <div class="col-xs-6 col-sm-3">
            <div class="font-w700 text-gray-darker animated fadeIn">Usuarios Registrados</div>
        ...
        <div class="col-xs-6 col-sm-3">
            <div class="font-w700 text-gray-darker animated fadeIn">Suplidores inscritos</div>
        ...
        <div class="col-xs-6 col-sm-3">
            <div class="font-w700 text-gray-darker animated fadeIn">Total Solicitudes</div>
        ...
        <div class="col-xs-6 col-sm-3">
            <div class="font-w700 text-gray-darker animated fadeIn">Cotizaciones Pendientes</div>
            <div class="text-muted animated fadeIn"><small><i class="si si-calendar"></i> All Time</small></div>
            ...
            <div class="block">
                ...
                <div class="block-content bg-gray-lighter">
                    <div class="row items-push">
                        ...
                        <div class="col-xs-4 h1 font-w300 text-right">{{ $numero }}</div>
                    </div>
                </div>
