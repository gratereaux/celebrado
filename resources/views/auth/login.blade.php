            ...
            <div class="col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 col-lg-4 col-lg-offset-4">
                <div class="push-30-t push-50 animated fadeIn">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-muted push-15-t">Arma tus fistas a la medida!</p>
                    </div>
                    <!-- END Login Title -->
                    ...
                    <form class="js-validation-login form-horizontal push-30-t" role="form" method="POST" action="{{ url('/login') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-xs-6">
                                <label class="css-input switch switch-sm switch-primary">
                                    <input type="checkbox" {{ old('remember') ? 'checked' : ''}} id="login-remember-me" name="remember"><span></span> Recordarme
                                </label>
                            </div>
                            <div class="col-xs-6">
